      ...
      <section className="color1 mb-5">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a
              href="#"
              className="heading3 inline-flex textcolor3 color2 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4 transition-all duration-300 hover:bg-green-400 transform hover:scale-110 hover:shadow-lg"
            >
              Back to Homepage
            </a>
          </div>
